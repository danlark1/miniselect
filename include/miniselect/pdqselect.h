...
namespace pdqsort_detail {
    ...
    template<class Iter, class Compare, bool Branchless>
    inline void pdqpartial_sort_loop(Iter begin, Iter mid, Iter end, Compare comp, int bad_allowed, bool leftmost = true) {
        typedef typename std::iterator_traits<Iter>::difference_type diff_t;
    ...
    template<class Iter, class Compare, bool Branchless>
    inline void pdqselect_loop(Iter begin, Iter mid, Iter end, Compare comp, int bad_allowed, bool leftmost = true) {
        typedef typename std::iterator_traits<Iter>::difference_type diff_t;
...
#if __cplusplus >= 201103L
    pdqsort_detail::pdqpartial_sort_loop<Iter, Compare,
        pdqsort_detail::is_default_compare<typename std::decay<Compare>::type>::value &&
        std::is_arithmetic<typename std::iterator_traits<Iter>::value_type>::value>(
...
template<class Iter, class Compare>
inline void pdqpartial_sort_branchless(Iter begin, Iter mid, Iter end, Compare comp) {
    if (begin == end) return;
...
#if __cplusplus >= 201103L
    pdqsort_detail::pdqselect_loop<Iter, Compare,
        pdqsort_detail::is_default_compare<typename std::decay<Compare>::type>::value &&
        std::is_arithmetic<typename std::iterator_traits<Iter>::value_type>::value>(
        begin, mid, end, comp, pdqsort_detail::log2(end - begin));
#else
